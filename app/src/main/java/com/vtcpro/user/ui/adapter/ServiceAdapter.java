package com.vtcpro.user.ui.adapter;
...
public class ServiceAdapter extends RecyclerView.Adapter<ServiceAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder,
        ...
        if (estimateFare != null) {
            ...
            try {
                holder.estimated_fixed.setText(BaseActivity.getNumberFormat().format(Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare()))));
...
//                        RateCardFragment.SERVICE = object;
                        RateCardFragment.base_price = String.valueOf(estimateFare.getEstimatedFare());
                        RateCardFragment.tax_price = String.valueOf(estimateFare.getTaxPrice());
