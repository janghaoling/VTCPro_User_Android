...
import com.vtcpro.user.ui.activity.change_password.ChangePasswordActivity;
...
public class ProfileActivity extends BaseActivity implements ProfileIView {
    ...
    public void initView() {
        ...
        llCompanyName = (LinearLayout) findViewById(R.id.ll_user_company);
...
//                fbOtpVerify(mCountry.getCode(), mCountry.getDialCode(), "");
    ...
    private void updateProfile() {
        ...
        } else if (firstName.getText().toString().isEmpty() && strUserType.equals(USER_TYPE_NORMAL)) {
            Toast.makeText(this, getString(R.string.invalid_first_name), Toast.LENGTH_SHORT).show();
        } else if (lastName.getText().toString().isEmpty() && strUserType.equals(USER_TYPE_NORMAL)) {
            Toast.makeText(this, getString(R.string.invalid_last_name), Toast.LENGTH_SHORT).show();
        } else if (companyName.getText().toString().isEmpty() && strUserType.equals(USER_TYPE_COMPANY)) {
            Toast.makeText(this, getString(R.string.invalid_company_name), Toast.LENGTH_SHORT).show();
    ...
    private void updateDetails() {
        ...
        if (strUserType.equals(USER_TYPE_NORMAL)) {
        ...
        if (strUserType.equals(USER_TYPE_COMPANY)) {
            map.put("company_name", RequestBody.create(MediaType.parse("text/plain"), companyName.getText().toString()));
        }
