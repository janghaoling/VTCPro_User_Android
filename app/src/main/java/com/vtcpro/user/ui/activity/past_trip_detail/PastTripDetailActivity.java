...
import com.vtcpro.user.data.network.model.Rating;
import com.vtcpro.user.ui.activity.zoom_view.ZoomPhotoActivity;
import com.vtcpro.user.ui.fragment.InvoiceDialogFragment;
import com.vtcpro.user.ui.fragment.dispute.DisputeCallBack;
import com.vtcpro.user.ui.fragment.dispute.DisputeFragment;
import com.vtcpro.user.ui.fragment.dispute_status.DisputeStatusFragment;
import com.vtcpro.user.ui.fragment.lost_item.LostFragment;
import com.vtcpro.user.ui.fragment.lost_item_status.LostItemStatusFragment;
...
//                timeFormat = new SimpleDateFormat("hh:mm a");
            ...
            if (datum.getWay_points() != null) {
                try {
                    ...
                    JSONArray array = new JSONArray(datum.getDestination_log());
                    if (jsonArray.length() > 0)
                        wAddress.setText(array.getJSONObject(0).get("address").toString());
                        dAddress.setText(jsonArray.getJSONObject(0).get("address").toString());
            ...
            if (payment != null)
                payable.setText(getNumberFormat().format(payment.getTotal() + payment.getTips()));
        }
    }
