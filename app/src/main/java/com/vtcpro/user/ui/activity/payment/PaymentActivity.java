...
import static com.vtcpro.user.MvpApplication.isBraintree;
import static com.vtcpro.user.MvpApplication.isCard;
import static com.vtcpro.user.MvpApplication.isCash;
import static com.vtcpro.user.MvpApplication.isPayumoney;
import static com.vtcpro.user.common.Constants.PaymentMode.CASH;
...
import static com.vtcpro.user.ui.fragment.invoice.InvoiceFragment.isInvoiceCashToCard;
...
public class PaymentActivity extends BaseActivity implements PaymentIView {
    ...
    @OnClick({R.id.add_card, R.id.cash, R.id.braintree, R.id.payumoney})
