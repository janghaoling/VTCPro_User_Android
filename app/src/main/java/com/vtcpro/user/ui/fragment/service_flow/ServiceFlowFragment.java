package com.vtcpro.user.ui.fragment.service_flow;
...
import com.vtcpro.user.common.CancelRequestInterface;
...
import com.vtcpro.user.data.network.model.ProviderService;
import com.vtcpro.user.data.network.model.ServiceType;
import com.vtcpro.user.ui.activity.VoiceCall;
import com.vtcpro.user.ui.activity.main.MainActivity;
import com.vtcpro.user.ui.activity.zoom_view.ZoomPhotoActivity;
import com.vtcpro.user.ui.fragment.cancel_ride.CancelRideDialogFragment;
...
import static com.vtcpro.user.MvpApplication.showOTP;
...
public class ServiceFlowFragment extends BaseFragment
    ...
    private void callPhoneNumber(String mobileNumber) {
        mCompositeDisposable.add(APIClient
                .getAPIClient()
                .postChatItem("user", String.valueOf(DATUM.getProviderId()), DATUM.getUser().getFirstName() + " wants to call you!  Tap here to answer")
                .subscribeOn(Schedulers.computation())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(o -> System.out.println("RRR o = " + o)));

        Intent i = new Intent(this.getContext(), VoiceCall.class);
