...
public class PlacesAutoCompleteAdapterOld extends RecyclerView.Adapter<PlacesAutoCompleteAdapterOld.PredictionHolder> implements Filterable {
    ...
    public PlacesAutoCompleteAdapterOld(Context context, int resource, GoogleApiClient googleApiClient, LatLngBounds bounds, AutocompleteFilter filter) {
        mContext = context;
        layout = resource;
